        ...
        <div class="header">
            <nav class="main-nav">
                <ul>
                    ...
                    <li class="nav-item"><a href="index.php" class="nav-link" data-link="taller7">Taller 7</a></li>
            ...
            <div class="formulario">
                <div class="card">
                    <form action="api.php" method="POST">
                        <h1>Nave espacial</h1>
                        <input class="texto" name="verificar" type="text" placeholder="Ingresa el tipo de nave espacial">
                        <button type="submit">Validar si la nave existe</button>
                    </form>
                    <div class="mensaje">
