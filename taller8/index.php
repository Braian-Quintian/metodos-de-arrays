        ...
        <div class="header">
            <nav class="main-nav">
                <ul>
                    ...
                    <li class="nav-item"><a href="index.php" class="nav-link" data-link="taller8">Taller 8</a></li>
            ...
            <div class="formulario">
                <div class="card">
                    <form action="api.php" method="POST">
                        <h1>Misión de exploración</h1>
                        <button type="submit">Seleccionar un planeta aleatorio</button>
                    </form>
                    <div class="mensaje">
                        <?php if (isset($_GET['planeta'])) : ?>
                            <h2>Planeta seleccionado:</h2>
                            <p><?php echo $_GET['planeta']; ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
